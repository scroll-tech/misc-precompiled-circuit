...
pub struct ModExpChip<F: PrimeField> {
...
impl<F: PrimeField + FromUniformBytes<64>> Number<F> {
...
impl<F: PrimeField> Chip<F> for ModExpChip<F> {
...
impl<F: PrimeField + FromUniformBytes<64>> ModExpChip<F> {
